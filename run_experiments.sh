...
echo "Check each experiment folder for:"
echo "  - config.json: Configuration used"
echo "  - training_curves.png: Training/validation curves"
echo "  - confusion_matrix.png: Confusion matrix"
echo "  - test_results.json: Test metrics"
echo ""
echo "Next steps:"
echo "1. Analyze results in each experiment folder"
echo "2. Fill in REPORT.md with findings"
